...
**EXPERIENTIAL VALIDATION: PENDING HUMAN PLAYTEST**. No hay integración Nexus.Server/ECS, gameplay posterior ni assets externos.
...
`Assets/Nexus/Experimental/Bootstrap.unity` sigue siendo una escena de diagnóstico con Main Camera y Directional Light. El fondo azul oscuro vacío es intencional. GameplayFeel01 es ahora la primera escena habilitada; Bootstrap es la segunda.

- `Assets/Nexus/Experimental`: Bootstrap, GameplayFeel01 y Feel01 (runtime experimental, tuning, autoría y tests).
...
El siguiente paso es el playtest humano de [Kinetic Vector V1](../../docs/design/gameplay-feel-findings.md); no iniciar V2 o Reactivity automáticamente.
